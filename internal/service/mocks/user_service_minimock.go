...
//go:generate minimock -i github.com/Oleg-Pro/auth/internal/service.UserService -o user_service_minimock.go -n UserServiceMock -p mocks
...
func (mmDelete *mUserServiceMockDelete) Return(i1 int64, err error) *UserServiceMock {
	if mmDelete.mock.funcDelete != nil {
		mmDelete.mock.t.Fatalf("UserServiceMock.Delete mock is already set by Set")
	}
	...
	mmDelete.defaultExpectation.results = &UserServiceMockDeleteResults{i1, err}
	mmDelete.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmDelete.mock
}

// Set uses given function f to mock the UserService.Delete method
func (mmDelete *mUserServiceMockDelete) Set(f func(ctx context.Context, id int64) (i1 int64, err error)) *UserServiceMock {
	if mmDelete.defaultExpectation != nil {
...
func (e *UserServiceMockDeleteExpectation) Then(i1 int64, err error) *UserServiceMock {
	e.results = &UserServiceMockDeleteResults{i1, err}
	return e.mock
}
...
func (mmDelete *UserServiceMock) Delete(ctx context.Context, id int64) (i1 int64, err error) {
...
func (mmUpdate *mUserServiceMockUpdate) Expect(ctx context.Context, id int64, info *model.UserUpdateInfo) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) ExpectInfoParam3(info *model.UserUpdateInfo) *mUserServiceMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mUserServiceMockUpdate) Inspect(f func(ctx context.Context, id int64, info *model.UserUpdateInfo)) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Set(f func(ctx context.Context, id int64, info *model.UserUpdateInfo) (i1 int64, err error)) *UserServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserServiceMockUpdate) When(ctx context.Context, id int64, info *model.UserUpdateInfo) *UserServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *UserServiceMock) Update(ctx context.Context, id int64, info *model.UserUpdateInfo) (i1 int64, err error) {
