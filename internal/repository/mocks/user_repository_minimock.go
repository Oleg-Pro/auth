...
//go:generate minimock -i github.com/Oleg-Pro/auth/internal/repository.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
...
func (mmDelete *mUserRepositoryMockDelete) Return(i1 int64, err error) *UserRepositoryMock {
	if mmDelete.mock.funcDelete != nil {
		mmDelete.mock.t.Fatalf("UserRepositoryMock.Delete mock is already set by Set")
	}
	...
	mmDelete.defaultExpectation.results = &UserRepositoryMockDeleteResults{i1, err}
	mmDelete.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmDelete.mock
}

// Set uses given function f to mock the UserRepository.Delete method
func (mmDelete *mUserRepositoryMockDelete) Set(f func(ctx context.Context, id int64) (i1 int64, err error)) *UserRepositoryMock {
	if mmDelete.defaultExpectation != nil {
...
func (e *UserRepositoryMockDeleteExpectation) Then(i1 int64, err error) *UserRepositoryMock {
	e.results = &UserRepositoryMockDeleteResults{i1, err}
	return e.mock
}
...
func (mmDelete *UserRepositoryMock) Delete(ctx context.Context, id int64) (i1 int64, err error) {
...
func (mmGet *mUserRepositoryMockGet) Expect(ctx context.Context, filter mm_repository.UserFilter) *mUserRepositoryMockGet {
...
func (mmGet *mUserRepositoryMockGet) ExpectFilterParam2(filter mm_repository.UserFilter) *mUserRepositoryMockGet {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserRepositoryMock.Get mock is already set by Set")
	}
...
func (mmGet *mUserRepositoryMockGet) Inspect(f func(ctx context.Context, filter mm_repository.UserFilter)) *mUserRepositoryMockGet {
...
func (mmGet *mUserRepositoryMockGet) Set(f func(ctx context.Context, filter mm_repository.UserFilter) (up1 *model.User, err error)) *UserRepositoryMock {
	if mmGet.defaultExpectation != nil {
...
// Then helper
func (mmGet *mUserRepositoryMockGet) When(ctx context.Context, filter mm_repository.UserFilter) *UserRepositoryMockGetExpectation {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserRepositoryMock.Get mock is already set by Set")
	}
...
func (mmGet *UserRepositoryMock) Get(ctx context.Context, filter mm_repository.UserFilter) (up1 *model.User, err error) {
...
func (mmUpdate *mUserRepositoryMockUpdate) Expect(ctx context.Context, id int64, info *model.UserUpdateInfo) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) ExpectInfoParam3(info *model.UserUpdateInfo) *mUserRepositoryMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mUserRepositoryMockUpdate) Inspect(f func(ctx context.Context, id int64, info *model.UserUpdateInfo)) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) Set(f func(ctx context.Context, id int64, info *model.UserUpdateInfo) (i1 int64, err error)) *UserRepositoryMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserRepositoryMockUpdate) When(ctx context.Context, id int64, info *model.UserUpdateInfo) *UserRepositoryMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
...
func (mmUpdate *UserRepositoryMock) Update(ctx context.Context, id int64, info *model.UserUpdateInfo) (i1 int64, err error) {
